  ...
  return (
    <Layout env={env} title="Client pipeline" path="/admin" noIndex admin>
      <section class="admin-shell">
        <div class="admin-title"><div><p class="eyebrow">Private operations</p><h1>Client pipeline</h1></div><a class="button button-small" href="/admin/products">New product passport</a></div>
  ...
  return (
    <Layout env={env} title="Growth playbook" path="/admin/playbook" noIndex admin>
      <section class="admin-shell playbook"><div class="admin-title"><div><p class="eyebrow">Brand & acquisition system</p><h1>Weekly playbook</h1></div></div>
        <div class="ratio-bar" aria-label="Content ratio"><span style="width:40%">40% Cases</span><span style="width:30%">30% Education</span><span style="width:20%">20% AI-ready</span><span style="width:10%">10% Service</span></div>
        ...
        <article class="admin-card roadmap-card"><h2>Current strategic sequence</h2><ol><li><strong>First real revenue</strong><span>Sell the One-Product First Fix.</span></li><li><strong>First documented case</strong><span>Upgrade the strongest fit to Visibility Launch.</span></li><li><strong>Choose the best vertical</strong><span>Follow reply, close, and repeat-purchase data.</span></li><li><strong>Standardize delivery</strong><span>Turn repeated work into checklists and templates.</span></li><li><strong>Build repeat & referral</strong><span>Use seasonal care and partner records.</span></li><li><strong>Grow discovery</strong><span>Publish approved, useful product passports.</span></li></ol></article>
