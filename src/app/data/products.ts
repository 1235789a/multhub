...
export const PRODUCTS: Product[] = [
  ...
  // 🎨 Marketing 系列 - Token 海报生成器
  {
    ...
    status: "available",
    launchPath: "/apps/token-poster-generator",
    trialConfig: { allowed: true, maxUses: 2 },
  },
  // 🚀 Marketing 系列 - Viral Campaign Planner（Web3 活动策划器）
  {
    name: {
      en: "Viral Campaign Planner",
      zh: "Viral Campaign Planner · 病毒式活动策划器",
    },
    slug: "viral-campaign-planner",
    icon: "🚀",
    version: "v1.0",
    priceBase: 29,
    priceDisplay: "4 USDT",
    ...
    features: {
      en: [
        "Generate complete Web3 campaign plans in minutes (Airdrop, Giveaway, Ambassador, Growth)",
        "Reward structure, task design, promotion plan, timeline all in one go",
        "Risk warnings and optimization suggestions included",
        "100 generations, one-time purchase",
      ],
      zh: [
        "5分钟生成完整 Web3 活动策划方案（空投、抽奖、大使、增长活动）",
        "奖励机制、任务设计、推广方案、时间线一次性输出",
        "包含女巫攻击风险提示与优化建议",
        "100次生成额度，一次买断",
      ],
    },
    status: "beta",
    launchPath: "/apps/viral-campaign-planner",
    trialConfig: { allowed: true, maxUses: 3 },
  },
