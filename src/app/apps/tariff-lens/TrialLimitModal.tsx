...
export default function TrialLimitModal({ isOpen, current, max }: TrialLimitModalProps) {
  ...
  const handleGoToCheckout = () => {
    router.push('/checkout/tariff-lens');
  };
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          onClick={(e) => e.stopPropagation()} // 禁止点击背景关闭
        >
          <motion.div
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 text-sm font-semibold text-white transition-all hover:from-blue-500 hover:to-indigo-500 active:scale-[0.98]"
                >
